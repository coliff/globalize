...
Globalize.prototype.dateFormatter = function( options ) {
	var cldr, numberFormatters, pad, pattern, properties, returnFn,
		args = options ? [].slice.call( arguments, 0 ) : [];
...
Globalize.prototype.dateParser = function( options ) {
	var cldr, numberParser, parseProperties, pattern, tokenizerProperties, returnFn,
		args = options ? [].slice.call( arguments, 0 ) : [];
